...
<script>
	...
	import systemApi from '@/api/model/system.js'
	...
	export default {
		...
		methods: {
			...
			async getMenu(){
				...
				var res = await systemApi.menu.list.get();
			...
			async add(node, data){
				...
				this.menuloading = true
				var res = await demoApi.post.post(newMenuData)
				this.menuloading = false
			...
			async delMenu(){
				...
				var res = await demoApi.post.post(reqData)
				this.menuloading = false
